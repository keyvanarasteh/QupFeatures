...
///
/// ```swift
/// .package(url: "https://github.com/keyvanarasteh/QupFeatures.git", from: "0.7.2"),
...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/keyvanarasteh/QupUX.git", from: "1.1.2"),
        .package(url: "https://github.com/keyvanarasteh/QupAPI.git", from: "1.1.2"),
        .package(url: "https://github.com/keyvanarasteh/QupSwiftAISDK.git", from: "10.0.5"),
        .package(url: "https://github.com/keyvanarasteh/QupFoundationModelsKit.git", from: "10.1.2"),
        .package(url: "https://github.com/keyvanarasteh/QupDynamicUI.git", from: "10.1.2"),
    ],
    targets: [
        .target(
