...
///
/// ```swift
/// .package(url: "https://github.com/keyvanarasteh/QupFeatures.git", from: "0.7.1"),
...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/keyvanarasteh/QupUX.git", from: "1.1.1"),
        .package(url: "https://github.com/keyvanarasteh/QupAPI.git", from: "1.1.1"),
