...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/keyvanarasteh/QupCore.git", branch: "master"),
        .package(url: "https://github.com/keyvanarasteh/QupDesignSystem.git", branch: "master"),
        .package(url: "https://github.com/keyvanarasteh/QupNetworking.git", branch: "master"),
        .package(url: "https://github.com/keyvanarasteh/QupFeatureContracts.git", branch: "master"),
        .package(url: "https://github.com/keyvanarasteh/QupQlineAuth.git", branch: "master"),
        .package(url: "https://github.com/keyvanarasteh/QupUX.git", branch: "master"),
        .package(url: "https://github.com/keyvanarasteh/QupAPI.git", branch: "master"),
        .package(url: "https://github.com/keyvanarasteh/QupSwiftAISDK.git", branch: "master"),
        .package(url: "https://github.com/keyvanarasteh/QupFoundationModelsKit.git", branch: "master"),
        .package(url: "https://github.com/keyvanarasteh/QupDynamicUI.git", branch: "master"),
    ],
    targets: [
        .target(
